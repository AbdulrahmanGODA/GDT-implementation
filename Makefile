...
all: boot.obj gdts.obj idts.obj kernel.obj gdt.obj vga.obj util.obj idt.obj keyboard.obj kernel GOOS.iso run 
...
kernel: $(BUILD_DIR)/boot.obj $(BUILD_DIR)/kernel.obj
	@ld -m elf_i386 -T linker.ld -o kernel $(BUILD_DIR)/boot.obj $(BUILD_DIR)/kernel.obj $(BUILD_DIR)/gdts.obj $(BUILD_DIR)/gdt.obj $(BUILD_DIR)/vga.obj $(BUILD_DIR)/util.obj $(BUILD_DIR)/idts.obj $(BUILD_DIR)/idt.obj $(BUILD_DIR)/keyboard.obj
